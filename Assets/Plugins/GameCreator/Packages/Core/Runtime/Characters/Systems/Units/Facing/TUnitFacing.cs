...
namespace GameCreator.Runtime.Characters
{
    ...
    public abstract class TUnitFacing : TUnit, IUnitFacing
    {
        ...
        [SerializeField] private bool m_UpdateRotation;
        ...
        public Vector3 LocalTargetFaceDirection => this.Transform.InverseTransformDirection(m_FaceDirection);

        public float PivotSpeed => this.m_PivotSpeed;
        
        // CONSTRUCTOR: ---------------------------------------------------------------------------

        protected TUnitFacing()
        {
            this.m_UpdateRotation = true;
        }
        ...
        public virtual void OnUpdate()
        {
            ...
            {
                this.m_FaceDirection = this.m_UpdateRotation
        ...
        protected Vector3 DecideDirection(Vector3 driverDirection)
        {
            ...
            return driverDirection == Vector3.zero ? currentDirection : driverDirection;
        }

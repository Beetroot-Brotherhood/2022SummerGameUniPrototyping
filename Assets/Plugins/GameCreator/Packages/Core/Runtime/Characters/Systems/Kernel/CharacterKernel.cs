...
namespace GameCreator.Runtime.Characters
{
    ...
    public class CharacterKernel : ICharacterKernel
    {
        ...
        {
            this.m_Player?.OnDrawGizmos(character);
            this.m_Motion?.OnDrawGizmos(character);
            this.m_Driver?.OnDrawGizmos(character);
            this.m_Facing?.OnDrawGizmos(character);
            this.m_Animim?.OnDrawGizmos(character);
        }
    }
}
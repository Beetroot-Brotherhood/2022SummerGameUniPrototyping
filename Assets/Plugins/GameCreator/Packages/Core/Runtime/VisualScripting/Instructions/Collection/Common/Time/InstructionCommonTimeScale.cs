...
namespace GameCreator.Runtime.VisualScripting
{
    ...
    [Example(
        ...
        "IDs. For example, if the Time Scale with ID = 0 has a value of 0.5 (which makes " +
        "characters move in slow motion), and another Time Scale with ID = 1 with a value of 0, " +
    ...
    [Parameter(
        "ID", 
        "Any time scale values using the same ID is overwritten by this one"
    )]

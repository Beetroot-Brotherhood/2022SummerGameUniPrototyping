...
namespace GameCreator.Runtime.Common
{
    public static class Easing
    {
        ...
        public static float GetEase(Type type, float from, float to, float t)
        {
            switch (type)
            {
                case Type.Linear: return Lerp(from, to, t);
                case Type.QuadIn: return QuadIn(from, to, t);
                case Type.QuadOut: return QuadOut(from, to, t);
                case Type.QuadInOut: return QuadInOut(from, to, t);
                case Type.QuadOutIn: return QuadOutIn(from, to, t);
                case Type.CubicIn: return CubicIn(from, to, t);
                case Type.CubicOut: return CubicOut(from, to, t);
                case Type.CubicInOut: return CubicInOut(from, to, t);
                case Type.CubicOutIn: return CubicOutIn(from, to, t);
                case Type.QuartIn: return QuartIn(from, to, t);
                case Type.QuartOut: return QuartOut(from, to, t);
                case Type.QuartInOut: return QuartInOut(from, to, t);
                case Type.QuartOutIn: return QuartOutIn(from, to, t);
                case Type.QuintIn: return QuintIn(from, to, t);
                case Type.QuintOut: return QuintOut(from, to, t);
                case Type.QuintInOut: return QuintInOut(from, to, t);
                case Type.QuintOutIn: return QuintOutIn(from, to, t);
                case Type.SineIn: return SineIn(from, to, t);
                case Type.SineOut: return SineOut(from, to, t);
                case Type.SineInOut: return SineInOut(from, to, t);
                case Type.SineOutIn: return SineOutIn(from, to, t);
                case Type.ExpoIn: return ExpoIn(from, to, t);
                case Type.ExpoOut: return ExpoOut(from, to, t);
                case Type.ExpoInOut: return ExpoInOut(from, to, t);
                case Type.ExpoOutIn: return ExpoOutIn(from, to, t);
                case Type.CircIn: return CircIn(from, to, t);
                case Type.CircOut: return CircOut(from, to, t);
                case Type.CircInOut: return CircInOut(from, to, t);
                case Type.CircOutIn: return CircOutIn(from, to, t);
                case Type.ElasticIn: return ElasticIn(from, to, t);
                case Type.ElasticOut: return ElasticOut(from, to, t);
                case Type.ElasticInOut: return ElasticInOut(from, to, t);
                case Type.ElasticOutIn: return ElasticOutIn(from, to, t);
                case Type.BackIn: return BackIn(from, to, t);
                case Type.BackOut: return BackOut(from, to, t);
                case Type.BackInOut: return BackInOut(from, to, t);
                case Type.BackOutIn: return BackOutIn(from, to, t);
                case Type.BounceIn: return BounceIn(from, to, t);
                case Type.BounceOut: return BounceOut(from, to, t);
                case Type.BounceInOut: return BounceInOut(from, to, t);
                case Type.BounceOutIn: return BounceOutIn(from, to, t);
            }

...
namespace GameCreator.Runtime.Common
{
    ...
    public class CompareMinDistanceOrNone
    {
        ...
        private static Color COLOR_EDITOR = new Color(0f, 256f, 0f, 0.25f);
        private static Color COLOR_IN = new Color(0f, 256f, 0f, 0.1f);
        private static Color COLOR_OUT = new Color(256f, 0f, 0f, 0.05f);

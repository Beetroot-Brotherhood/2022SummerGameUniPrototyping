...
namespace GameCreator.Editor.VisualScripting
{
    public class ConditionListTool : TPolymorphicListTool
    {
        ...
        private readonly ConditionList m_Conditions;
        ...
        public ConditionListTool(SerializedProperty property)
            : base(property, "m_Conditions")
        {
            this.SerializedObject.Update();
            
            this.m_Conditions = property.GetValue<ConditionList>();
        ...
        protected override void SetupFoot()
        {
            ...
            this.m_ButtonPlay = new Button(() => this.m_Conditions?.Check(null))
            {
                name = "GC-Condition-List-Foot-Button"
            };
